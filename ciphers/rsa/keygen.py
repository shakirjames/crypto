...
from ..cryptolib import cryptomath, primes


def main(name='textbook_rsa'):
    # create a public/private keypair with 1024 bit keys
    print('Making key files...')
    makeKeyFiles(name, 1024)
...
def generateKey(keySize):
    ...
    p = primes.generate_large_prime(keySize)
    print('Generating q prime...')
    q = primes.generate_large_prime(keySize)
    n = p * q
